...
public class MyWebview extends WebView {
    ...
    private void requestPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(mActivity.get(), android.Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            ...
            ActivityCompat.requestPermissions(mActivity.get(), new String[]{android.Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_MULTIPLE_ID_PERMISSIONS);
        }
    }
